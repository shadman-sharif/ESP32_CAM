/*
  ESP32-CAM - Example 03
  Simple Browser Live View
  ...
  - Shows an MJPEG-style live stream in a browser

  Before uploading:
  1. Change WIFI_SSID
  2. Change WIFI_PASSWORD
  3. Select the correct ESP32-CAM board
  4. Use the required download/boot mode
*/
